...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Добавление критерия оценивания категории подкатегорий</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/AddEvaluationCriterionCategorySubcategory.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="header-block">
                <h1>Добавление критерия оценивания категории подкатегорий</h1>
            </div>
