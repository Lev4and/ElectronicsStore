...
$unit = QueryExecutor::getInstance()->getUnit($_GET["unitId"]);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Изменение данных об единицы измерения</title>
                        ...
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="name" value="<?php echo $unit["name"] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-block-row">
