...
$characteristicQuantityUnitValue = QueryExecutor::getInstance()->getCharacteristicQuantityUnitValue($_GET["characteristicQuantityUnitValueId"]);
...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Изменение данных о значении характеристики</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/EditCharacteristicQuantityUnitValue.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="header-block">
                <h1>Изменение данных о значении характеристики</h1>
            </div>
            <div class="form-block">
                <form action=".?characteristicQuantityUnitValueId=<?php echo $_GET["characteristicQuantityUnitValueId"]; ?>" method="post">
                                ...
                                <div class="form-block-row-column-input-select">
                                    <select id="select-characteristics" name="characteristicId">
                                        ...
                                        <?php foreach ($characteristics as $characteristic): ?>
                                            <option value="<?php echo $characteristic["id"]; ?>" <?php echo $characteristic["id"] == $characteristicQuantityUnitValue["characteristic_id"] ? 'selected="selected"' : ""; ?>><?php echo $characteristic["name"]; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-block-row-column-input-select">
                                    <select name="quantityUnitId">
                                        ...
                                        <?php foreach ($quantityUnits as $quantityUnit): ?>
                                            <option value="<?php echo $quantityUnit["id"]; ?>" <?php echo $quantityUnit["id"] == $characteristicQuantityUnitValue["quantity_unit_id"] ? 'selected="selected"' : ""; ?>><?php echo $quantityUnit["quantity_name"] . " - (" . $quantityUnit["unit_name"] . " (" . $quantityUnit["unit_designation"] . "))"; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-block-row">
                            ...
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="value" value="<?php echo $characteristicQuantityUnitValue["value"]; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
