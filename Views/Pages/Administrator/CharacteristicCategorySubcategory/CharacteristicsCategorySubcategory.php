    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="content-counter-values">
                <span>Характеристики категории подкатегории <span id="counter-values"><?php echo NumWord::numberWord(count($characteristicsCategorySubcategory), array('запись', 'записи', 'записей')); ?></span></span>
            </div>
                    ...
                    <fieldset class="filters-block">
                        ...
                        <div class="filter">
                            <div class="filter-collapsible-block" onclick="onClickOpenCollapsibleBlock(this);">
                                <div class="filter-title"><i class="fas fa-chevron-up"></i><span>Разделы</span></div>
                            </div>
                            <div id="filter-collapsible-content-collapsible" class="filter-collapsible-content">
                                <div class="filter-collapsible-content-select-container">
                                    <select id="select-sections" name="sectionId" onchange="onSelectedChanged(this);">
                        ...
                        <div class="filter">
                            <div class="filter-collapsible-block" onclick="onClickOpenCollapsibleBlock(this);">
                                <div class="filter-title"><i class="fas fa-chevron-up"></i><span>Используется при фильтрации?</span></div>
                            </div>
                            <div id="filter-collapsible-content-collapsible" class="filter-collapsible-content">
                                <div class="filter-collapsible-content-select-container">
                                    <select id="select-use-when-filtering" name="useWhenFiltering" onchange="onSelectedChanged(this);">
                        ...
                        <div class="filter">
                            <div class="filter-collapsible-block" onclick="onClickOpenCollapsibleBlock(this);">
                                <div class="filter-title"><i class="fas fa-chevron-up"></i><span>Используется как основная информация?</span></div>
                            </div>
                            <div id="filter-collapsible-content-collapsible" class="filter-collapsible-content">
                                <div class="filter-collapsible-content-select-container">
                                    <select id="use-when-displaying-as-basic-information" name="useWhenDisplayingAsBasicInformation" onchange="onSelectedChanged(this);">
                                        <option value="">Не имеет значения</option>
                                        <option value="0">Нет</option>
                                        <option value="1">Да</option>
                                    </select>
