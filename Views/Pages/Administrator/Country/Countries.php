...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Страны</title>
    <link rel="stylesheet" href="/CSS/Pages/Countries.css">
    <link rel="stylesheet" href="/CSS/Elements/Header.css">
    <link rel="stylesheet" href="/CSS/Elements/MenuUser.css">
    <link rel="stylesheet" href="/CSS/Elements/MenuAdmin.css">
    <link rel="stylesheet" href="/CSS/Elements/Toolbar.css">
    <link rel="stylesheet" href="/CSS/Elements/TableCountries.css">
...
<div class="main">
    ...
    <div class="content">
        <?php if(isset($_SESSION["user"]) && count($_SESSION["user"]) > 0 && $_SESSION["user"]["role_name"] == "Администратор"): ?>
            ...
            <form action="http://electronicsstore/Views/Pages/Administrator/Country/" method="post">
                <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/Toolbar.php"; ?>
                <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/TableCountries.php"; ?>
            </form>
