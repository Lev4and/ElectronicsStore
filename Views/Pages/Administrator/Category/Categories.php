    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="content-counter-values">
                <span>Категории <span id="counter-values"><?php echo NumWord::numberWord(count($categories), array('запись', 'записи', 'записей')); ?></span></span>
            </div>
                        ...
                        <div class="filter">
                            ...
                            <div id="filter-collapsible-content-collapsible" class="filter-collapsible-content">
                                <div class="filter-collapsible-content-select-container">
                                    <select id="select-classifications" name="classificationId" onchange="onSelectedChanged(this);">
