...
$section = QueryExecutor::getInstance()->getSection($_GET["sectionId"]);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Изменение данных о разделе характеристики</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/EditSection.css">
        ...
        <?php if(Access::isAdministrator()): ?>
            <div class="breadcrumb-list">
                <ul>
                    ...
                    <li><a href="../Section/"><span>Сущность БД: Разделы характеристик</span></a></li>
                </ul>
            </div>
            <div class="header-block">
                <h1>Изменение данных о разделе характеристики</h1>
            </div>
            <div class="form-block">
                <form action=".?sectionId=<?php echo $section["id"]; ?>" method="post">
                    <div class="form-block-inputs">
                        <div class="form-block-row">
                            <div id="form-block-row-column-label" class="form-block-row-column">
                                <div class="form-block-row-column-label">
                                    <label>Введите название раздела характеристики:</label>
                                </div>
                            </div>
                            <div id="form-block-row-column-input" class="form-block-row-column">
                                <div class="form-block-row-column-input-text">
                                    <input type="text" name="name" value="<?php echo $section["name"]; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
