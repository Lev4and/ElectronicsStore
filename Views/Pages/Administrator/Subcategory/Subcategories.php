...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Подкатегории</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/Subcategories.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="content-counter-values">
                <span>Подкатегории <span id="counter-values"><?php echo NumWord::numberWord(count($subcategories), array('запись', 'записи', 'записей')); ?></span></span>
            </div>
                ...
                <div style="width: 100%; display: flex; flex-direction: row; justify-content: space-between;">
                    <fieldset class="filters-block">
                        ...
                        <div class="filter">
                            ...
                            <div id="filter-collapsible-content-collapsible" class="filter-collapsible-content">
                                <div class="filter-collapsible-content-select-container">
                                    <select id="select-categories" name="categoryId" onchange="onSelectedChanged(this);">
                    ...
                    <div class="content-container" style="width: 65%;">
                        <div id="tableBlock">
                            <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/TableSubcategories.php"; ?>
                        </div>
