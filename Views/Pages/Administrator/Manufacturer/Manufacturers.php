...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Производители</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/Manufacturers.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="content-counter-values">
                <span>Производители <span id="counter-values"><?php echo NumWord::numberWord(count($manufacturers), array('запись', 'записи', 'записей')); ?></span></span>
            </div>
