...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Критерии оценивания</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/EvaluationCriterions.css">
    ...
    <script src="/JS/EvaluationCriterions.js"></script>
</head>
<body>
<div class="main">
    <?php
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="content-counter-values">
                <span>Критерии оценивания <span id="counter-values"><?php echo NumWord::numberWord(count($evaluationCriterions), array('запись', 'записи', 'записей')); ?></span></span>
            </div>
            <form id="filtersForm" action="." method="post">
                ...
                <div style="width: 100%; display: flex; flex-direction: row; justify-content: space-between;">
                    ...
                    <div class="content-container" style="width: 65%;">
                        <div id="tableBlock">
                            <?php include $_SERVER["DOCUMENT_ROOT"] . "/Views/Renders/TableEvaluationCriterions.php"; ?>
                        </div>
