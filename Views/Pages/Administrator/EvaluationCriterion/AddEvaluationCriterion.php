...
<head>
    <meta charset="UTF-8">
    <title>ElectronicsStore - Добавление критерия оценивания</title>
    <link rel="stylesheet" href="/CSS/Pages/Main.css">
    <link rel="stylesheet" href="/CSS/Pages/AddEvaluationCriterion.css">
    ...
    <div class="content">
        <?php if(Access::isAdministrator()): ?>
            ...
            <div class="header-block">
                <h1>Добавление критерия оценивания</h1>
            </div>
