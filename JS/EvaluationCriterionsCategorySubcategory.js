function onChangeSelectedClassifications(selectClassifications) {
    ...
    const url = "http://electronicsstore/Views/Pages/Administrator/EvaluationCriterionCategorySubcategory/";
...
function onClickApply() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/EvaluationCriterionCategorySubcategory/?action=Применить";
    const params = "";
...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/EvaluationCriterionCategorySubcategory/?action=Предварительное применение фильтров";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/EvaluationCriterionCategorySubcategory/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/EvaluationCriterionCategorySubcategory/?action=Обновить нумерацию страниц";
