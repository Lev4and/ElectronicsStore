function onClickApply() {
    ...
    const url = "http://electronicsstore/Views/Pages/Administrator/CharacteristicQuantityUnitValue/?action=Применить";
    const params = "";
...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CharacteristicQuantityUnitValue/?action=Предварительное применение фильтров";
...
function updateCounterValuesFilterArrowLeft() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CharacteristicQuantityUnitValue/";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CharacteristicQuantityUnitValue/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CharacteristicQuantityUnitValue/?action=Обновить нумерацию страниц";
