...
function onChangeSelectedCategories(selectCategories) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CategorySubcategory/";
...
function onClickApply() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CategorySubcategory/?action=Применить";
    const params = "";
...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CategorySubcategory/?action=Предварительное применение фильтров";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CategorySubcategory/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/CategorySubcategory/?action=Обновить нумерацию страниц";
