function onClickApply() {
    ...
    const url = "http://electronicsstore/Views/Pages/Administrator/QuantityUnit/?action=Применить";
    const params = "";
...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/QuantityUnit/?action=Предварительное применение фильтров";
...
function updateCounterValuesFilterArrowLeft() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/QuantityUnit/";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/QuantityUnit/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/QuantityUnit/?action=Обновить нумерацию страниц";
