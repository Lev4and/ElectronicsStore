...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/Category/?action=Предварительное применение фильтров";
...
function updateCounterValuesFilterArrowLeft() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/Category/";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/Category/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/Category/?action=Обновить нумерацию страниц";
