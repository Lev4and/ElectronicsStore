...
function onClickApply() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/City/?action=Применить";
    const params = "";
...
function preApplyFilters(){
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/City/?action=Предварительное применение фильтров";
...
function onChangePage(numberPage) {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/City/?action=Поменять страницу&numberPage=" + numberPage;
...
function updatePagination() {
    const request = getXmlHttp();
    const url = "http://electronicsstore/Views/Pages/Administrator/City/?action=Обновить нумерацию страниц";
